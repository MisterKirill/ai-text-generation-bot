...
bot.on('messageCreate', msg => {
    ...
    if(msg.channelId == process.env.ALLOWED_CHANNEL && msg.content) {
        ...
        axios.post('https://api-inference.huggingface.co/models/fossai/cheburek-davinci-1', JSON.stringify(msg.content), {
            headers: {
            ...
            if(err.data.error) {
                if(err.data.error == 'Model fossai/cheburek-davinci-1 is currently loading') {
